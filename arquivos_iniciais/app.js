...
class Bd {
    ...
    recuperarTodosRegistros() {
        ...
        for(let i = 1; i <= id; i++) {
            ...
            // existe a possibvilidade de haver indices que foram pulados/removidos
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
    ...
    // selecionando o elemento tbdody da tabela
    ...
    despesas.forEach(function(d) {
        ...
        btn.onclick = function() {
            ...
            document.getElementById('modal_botao2').onclick = function() {
                // remover a despesa
